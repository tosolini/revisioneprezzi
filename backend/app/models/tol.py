...
class TolAssignment(Base):
    ...
    tol_code: Mapped[str] = mapped_column(String(10), ForeignKey("tol_master.code"), nullable=False)
...
class TolIndexSeries(Base):
    ...
    series_id: Mapped[str] = mapped_column(
        String(100), nullable=False, comment="ID della serie ISTAT/MIT associata alla TOL"
    )
